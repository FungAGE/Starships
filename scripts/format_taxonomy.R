...
starships<-read_tsv("ships/manual-annotations/Starships.withtaxa.tsv",col_names=c("Class","Species","Strain","Code","Size","TSD","aTIR","Spok","ARS","Other","HGT","taxID","taxRank","names","ranks")) %>%
...
starships %>%
  ...
  write_csv(file="ships/manual-annotations/Starships.fulltaxa.csv")
