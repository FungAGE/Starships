...
starships<-read_tsv("Starships.withtaxa.tsv",col_names=c("Family","Species","Strain","Code","Navis","Size","DR","aTIR","Target","Spok","ARS","Other","HGT","taxID","taxRank","names","ranks")) %>% 
